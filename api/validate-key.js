...
// api/validate-key.ts
var validate_key_exports = {};
__export(validate_key_exports, {
  default: () => handler
});
module.exports = __toCommonJS(validate_key_exports);
...
// api/validate-key.ts
var { MIN_API_KEY_LENGTH, MAX_API_KEY_LENGTH } = API_VALIDATION;
