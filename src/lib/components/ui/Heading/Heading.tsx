...
export function Heading({ level, children, className = '' }: HeadingProps) {
  ...
  const levelClasses = {
    hero: 'text-[var(--font-size-hero)] leading-tight font-semibold tracking-[-0.03em]',
    h1: 'text-[var(--font-size-h1)] leading-tight font-semibold tracking-[-0.02em]',
    h2: 'text-[var(--font-size-h2)] leading-snug font-medium tracking-[-0.01em]',
    h3: 'text-[var(--font-size-h3)] leading-normal font-normal',
  };
