  ...
  useTranslation: () => ({
    t: (key: string) => {
      const map: Record<string, string> = {
        ...
        'onboarding.step1.useCases.meeting': 'Meeting',
        'onboarding.step1.useCases.lecture': 'Lecture',
        'onboarding.step1.useCases.interview': 'Interview',
        'onboarding.step1.useCases.podcast': 'Podcast',
        'onboarding.step1.useCases.voiceMemo': 'Voice Memo',
        'onboarding.step1.useCases.other': 'Other',
