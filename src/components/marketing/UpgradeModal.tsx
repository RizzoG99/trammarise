    ...
    switch (trigger) {
      case 'limit_reached':
        return {
          ...
          description: t('upgrade.limitReached.desc', 'Free users are limited to 60 minutes of processing per month. Upgrade to Pro for 500 minutes!'),
      ...
      case 'chat_gate':
        return {
          ...
          description: t('upgrade.chatGate.desc', 'Chatting with your transcript is a Pro feature. Upgrade to ask questions and get insights instantly.'),
      ...
      case 'watermark_remove':
        return {
          ...
          description: t('upgrade.watermark.desc', 'Professional documents require a professional look. Upgrade to remove the Trammarise watermark.'),
      ...
      case 'history_limit':
        return {
          ...
          description: t('upgrade.history.desc', 'Free users can only access their last 5 recordings. Upgrade to access your entire archive.'),
      ...
      default:
        return {
          ...
          description: customDescription || t('upgrade.generic.desc', 'Unlock the full power of Trammarise with a Pro subscription.'),
    ...
    <Modal isOpen={isOpen} onClose={onClose} title={content.title}>
      <div className="flex flex-col items-center text-center p-4">
        ...
        <div className="flex flex-col w-full gap-3">
          <Button onClick={handleUpgrade} className="w-full justify-center" size="lg">
