  ...
  return (
    <div className="w-full max-w-[800px] mx-auto py-8 px-4 animate-[fadeIn_0.3s_ease-out] md:p-4">
      <div className="text-center mb-8">
        <h1 className="m-0 mb-2 text-3xl font-bold text-slate-900 dark:text-white md:text-2xl">Configure AI Processing</h1>
      ...
      <div className="mb-10 p-6 bg-white dark:bg-slate-800 border border-slate-200 dark:border-slate-700 rounded-xl shadow-sm">
        <h3 className="m-0 mb-4 text-lg font-semibold text-slate-900 dark:text-white">Transcript Preview</h3>
        <div className="mb-3 p-4 bg-slate-50 dark:bg-slate-900/50 rounded-lg max-h-[120px] overflow-y-auto border border-slate-200 dark:border-slate-700">
          <p className="m-0 text-slate-700 dark:text-slate-300 leading-relaxed text-[0.95rem]">{transcript.substring(0, 300)}...</p>
        </div>
        <p className="m-0 text-sm text-slate-500 dark:text-slate-400 italic">Full transcript will be processed with your selected AI model</p>
      </div>
